...
const AboutMe = (mode) => (
  <div className="Body-Info About-Me">
    ...
    <div className="Center Showable">
      <h2 style={{ textAlign: "center", fontSize: "calc(2vw + min(3vw, 1.5rem)" }}>
    ...
    <div className={`About-Me-Info Overlay ${mode}`}>
      <p>
      ...
      <p>
        Over the years, I have worked on many personal projects, usually in the form of video games. But, with each game I create, I engage in a different challenge, from AI pathfinding to Networking in online games.
      </p>
      <br />
      <p>
        If you would like to see what I have worked on, scroll for more!
      </p>
    </div>
  </div>
    ...
    return (
      <div className='Project-Expanded' key={Math.random()}>
        ...
        <div id={`project-${id}`} className={`Showable Project-Container ${mode}`}>
          ...
          <div className='Project-Body Fade'>
            ...
            <div className='Text-Promt' onClick={() => handleProjectClick(-1, currentProj)}>
              Show less.
  ...
  return (
    <div id={`project-${id}`} className={`Showable Project-Container ${mode} Shrunk`} key={Math.random()}>
      <div className="Main-Info">
        ...
        <h2 className={`Project-Title ${mode}`}>{title}</h2>
      </div>

      <div className='Text-Promt' style={mode === "Dark" ? { color: "black" } : { color: "white" }} onClick={() => handleProjectClick(id, currentProj)}>
        Show more!
        <div className="Border-Bottom">
        </div>
...
const Connect = (props) => (
  <div className="Body-Info Showable Fade">
